...
RACE_CARD    = BASE / "racecards" / "20260204 Race all form.xlsx"   # YYYYDDMM format
SHEET_NAME   = "Sheet1"                                             # increments per meeting
USE_SCRAPED  = False                                                 # True for scraped race card format
EXP_TIME_REF = BASE / "expected_time_references_v3.xlsx"
ABILITY_FILE = BASE / "horse_ability_analysis_v3.xlsx"

OUT_PDF  = BASE / "reports" / "race_day_report_20260402_v3.4.8.pdf"
OUT_TEXT = BASE / "reports" / "race_day_analysis_20260402_v3.4.8.txt"
DB_FILE  = BASE / "hkjc_results_updated.xlsx"

MEETING_TITLE = "HAPPY VALLEY — WEDNESDAY, 2 APRIL 2026"
MEETING_VENUE = "HV"
